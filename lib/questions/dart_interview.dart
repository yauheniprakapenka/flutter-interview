...
dynamic → переменная может хранить значения любых типов в любой момент, проверки типов откладываются на runtime. Ошибки ловятся только при выполнении.
...
''',
  ...
  QA(
    ...
    q: 'Изоляты в общаются копированием или ссылками?',
    a: '''
...
''',
  ...
  QA(
    ...
    a: '''
`late` позволяет отложить инициализацию переменной, при этом она не считается nullable, что помогает избежать проверок на null при гарантированной инициализации.
''',
  ),
  QA(
    tags: [Tag.dart],
